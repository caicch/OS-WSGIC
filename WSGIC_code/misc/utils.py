...
class LanguageModelCriterion(nn.Module):
    ...
    def forward(self, input, target, mask):
        # truncate to the same size #target 50, 17,   input 50, 17, 7001  #mask 50, 17
...
class clsModelCriterion(nn.Module):
    def __init__(self):
        super(clsModelCriterion, self).__init__()
