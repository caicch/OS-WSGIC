...
def parse_opt():
    ...
    parser.add_argument('--dataset', type=str, default='flickr',
                    help='coco|flickr')
    parser.add_argument('--input_json', type=str, default='/mnt/data/flickr30k/data/flickrtalk.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_fc_dir', type=str, default='/mnt/data/flickr30k/data/flickrbu/flickrbu_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='/mnt/data/flickr30k/data/flickrbu/flickrbu_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='/mnt/data/flickr30k/data/flickrbu/flickrbu_box',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='/mnt/data/flickr30k/data/flickrtalk_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
    ...
    # Model settings
    parser.add_argument('--caption_model', type=str, default='GIC',
                    help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, transformer, aoa')
    ...
    parser.add_argument('--use_ff', type=int, default=1,
                        help = 'use_feed_forward')

    #deit_tr
    parser.add_argument('--num_heads_deit', type=int, default=1,
                        help='number of heads')
    parser.add_argument('--deit_size', type=int, default=768,
                        help='size of the rnn in number of hidden nodes in each layer. 512 for flickr and 1024 for coco')
    ...
    parser.add_argument('--batch_size', type=int, default=10,#29 for flickr， 32 for mscoco
                    help='minibatch size')
    ...
    parser.add_argument('--checkpoint_path', type=str, default='log/CE',
    ...
    # misc
    parser.add_argument('--id', type=str, default='CE_train',
    ...
    # default 0.1
    parser.add_argument('--att_supervise_weight', type=float, default=0.1,
                    help='att_supervise_weight')

    parser.add_argument('--use_gt_box', type=bool, default=False,
                    help='whether use gt box supervise')

    parser.add_argument('--image_path', type=str, default='/mnt/data/flickr30k/data/flickr30k-images/',
                        help='image_path')
    ...
    #semantic
    parser.add_argument('--input_label_h5_predicates', type=str, default='./data/flickrtalk_relation_label.h5',
                        help='path to the h5file containing the preprocessed dataset')
    #parser.add_argument('--input_deit', type=str, default='/mnt/data/flickr30k/data/flickr_feats_layer12_resize384/',
    #                    help='path to the directory containing the preprocessed deit feats')
    parser.add_argument('--cv_num_heads', type=int, default=12,
                        help='number of cv_heads')
    parser.add_argument('--cv_size', type=int, default=768,
                        help='size of the rnn in number of hidden nodes in each layer. 512 for flickr and 1024 for coco')
