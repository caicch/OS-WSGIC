...
parser.add_argument('--thresholding', type=float, default=0.05,
                help='treshholding')
...
parser.add_argument('--image_root', type=str, default='/data/flickr_30k/data/images/',
...
parser.add_argument('--eval_att', type=int, default=1,
...
crit_MLS = torch.nn.MultiLabelSoftMarginLoss().cuda()
...
# pdb.set_trace()
opt.vocab = vocab
loss, split_predictions, lang_stats = eval_utils.eval_split(model, crit, crit_MLS, loader, vars(opt))
