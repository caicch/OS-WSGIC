        ...
        while True:
            ...
            if opt.use_gt_box:
                ...
                tmp = [data['fc_feats'], data['att_feats'], data['labels'], data['masks'], data['att_masks'], data['images'],
                       data['verb']]
                tmp = [_ if _ is None else _.cuda() for _ in tmp]
                fc_feats, att_feats, labels, masks, att_masks, images, verb = tmp #deit_images , image_attns
            ...
            model_out = lw_model(fc_feats, att_feats, labels, masks, att_masks, images, verb, data['gts'], torch.arange(0, len(data['gts'])), sc_flag, box_inds) #image_attns
            ...
            #utils.clip_gradient(optimizer_vit, opt.grad_clip)
            #optimizer_vit.step()
            optimizer.step()
            ...
            if (iteration % opt.save_checkpoint_every == 0):
                ...
                val_loss, predictions, lang_stats = eval_utils.eval_split(
                    model, lw_model.crit, lw_model.crit_MLS, loader, eval_kwargs)
